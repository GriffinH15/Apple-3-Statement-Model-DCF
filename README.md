...
- My implied share price is lower than the real share price for a few main reasons. One is the intrinsic value of Apple which can't be measured with numbers, as well as the AI space and how that is influencing investors. I also was on the more conservative side with my assumptions and didn't have Apple have really advantageous assumptions that would dramatically increase share price.
